...
<div class="w2dc-search-section" id="w2dc_search_fields_<?php echo $search_form_id; ?>">
	...
	<input type="hidden" name="use_advanced" id="use_advanced_<?php echo $search_form_id; ?>" value="<?php echo $advanced_open; ?>" />
