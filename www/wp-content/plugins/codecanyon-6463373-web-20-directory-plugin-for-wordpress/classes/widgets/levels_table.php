...
$w2dc_levels_table_widget_params = array(
		...
		array(
				...
				'description' => __('Show parameters those have negation. For example, such row in table will be shown: Featured Listings - No. In other case this row will be hidden.', 'W2DC'),
		),
		array(
				'type' => 'dropdown',
