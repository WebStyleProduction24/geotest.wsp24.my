								...
								'maps' => array(
									...
									'fields' => array(
										...
										array(
											...
											'label' => __('Enable default user Geolocation', 'W2GM'),
								...
								'addresses' => array(
									...
									'fields' => array(
										array(
											...
											'description' => __('This value needed when you build local directory, all your listings place in one local area - country or state. You do not want to set countries or states in the search, so this hidden string will be automatically added to the address for correct geocoding when you create/edit listings.', 'W2DC'),
								...
								'google_api' => array(
									...
									'fields' => array(
										array(
											...
											'description' => sprintf(__('get your Google API key <a href="%s" target="_blank">here</a>, following APIs must be enabled in the console: Google Maps Directions API, Google Maps Geocoding API, Google Maps JavaScript API, Google Places API Web Service and Google Static Maps API.', 'W2DC'), 'https://console.developers.google.com/flows/enableapi?apiid=maps_backend,geocoding_backend,directions_backend,static_maps_backend,places_backend&keyType=CLIENT_SIDE&reusekey=true') . ' ' . sprintf(__('Then check geolocation <a href="%s">response</a>.', 'W2DC'), admin_url('admin.php?page=w2dc_debug')),
